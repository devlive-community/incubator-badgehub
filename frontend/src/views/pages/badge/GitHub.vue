...
const onSubmit = () => {
  ...
  request.get(`/github/${ formState.value.organization }/${ formState.value.repo }.svg`, { params: params })
         .then(response => {
           ...
           path.value = {
             URL: `${ root }/api/github/${ formState.value.organization }/${ formState.value.repo }.svg`,
             Markdown: `![Static Badge](${ root }/api/github/${ formState.value.organization }/${ formState.value.repo }.svg)`,
             HTML: `<img alt="Static Badge" src="${ root }/api/github/${ formState.value.organization }/${ formState.value.repo }.svg"/>`
           }
         })
